...
namespace shopChart
{
    public class ProductsDbController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductID,Name,CategoryID,Price,ProducerID")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductID,Name,CategoryID,Price,ProducerID")] Product product)
        {
