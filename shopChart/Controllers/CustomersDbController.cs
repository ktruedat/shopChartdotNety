...
namespace shopChart
{
    public class CustomersDbController : Controller
    {
        ...
        public CustomersDbController(ProductContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Customers != null ? 
                          ...
                          Problem("Entity set 'ProductContext.Customers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProductContext.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
